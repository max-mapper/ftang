    ...
    return this.each(function(){
      ...
      function bindHandlers(){
        ...
        $('a', $letters).hover(function(){
          ...
          if(letter == 'all'){
            ...
            isAll = true;
            $('li').css({'font-size' : '18px', 'padding-left' : '5px', 'padding-right' : '5px'});
          } else {
            if(isAll){
              $list.children().hide();
              isAll = false;
            ...
            if (count > 0) {
              ...
              $('li').css({'font-size' : '30px', 'padding-left' : '15px', 'padding-right' : '15px'});
            }
      ...
      function createLettersHtml(){
        ...
        for(var i=1;i<letters.length;i++){
          if (html.length == 0) html.push('<a class="all" href="#">ALL</a><a class="_" href="#">#</a>');
